...
public class UpdatePayoffCommandHandler : IRequestHandler<UpdateDebtsCommand, int>
{
    private readonly IDbContext _dbContext;
    public UpdatePayoffCommandHandler(IDbContext dbContext) => _dbContext = dbContext;
