...
public class GetPayoffDetailsQueryHandler : IRequestHandler<GetDepositDetailsQuery, BankDeposit>
{
    private readonly IDbContext _dbContext;
    private readonly IMapper _mapper;

    public GetPayoffDetailsQueryHandler(IDbContext dbContext, IMapper mapper)
    {
