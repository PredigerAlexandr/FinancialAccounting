...
public class UpdateDebtsCommandHandler : IRequestHandler<UpdateDebtsCommand, int>
{
    private readonly IDbContext _dbContext;
    public UpdateDebtsCommandHandler(IDbContext dbContext) => _dbContext = dbContext;
