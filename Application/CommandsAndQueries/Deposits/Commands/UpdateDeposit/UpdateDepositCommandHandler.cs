...
public class UpdateDepositCommandHandler : IRequestHandler<UpdateDebtsCommand, int>
{
    private readonly IDbContext _dbContext;
    public UpdateDepositCommandHandler(IDbContext dbContext) => _dbContext = dbContext;
