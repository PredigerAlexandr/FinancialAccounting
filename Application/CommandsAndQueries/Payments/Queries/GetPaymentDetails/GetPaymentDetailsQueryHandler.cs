...
public class GetPaymentDetailsQueryHandler : IRequestHandler<GetDepositDetailsQuery, BankDeposit>
{
    private readonly IDbContext _dbContext;
    private readonly IMapper _mapper;

    public GetPaymentDetailsQueryHandler(IDbContext dbContext, IMapper mapper)
    {
